...
namespace UnityEditor
{
	...
	internal class AudioImporterInspector : AssetImporterInspector
	{
		...
		{
			internal UnityEngine.Object[] <$s_1243>__0;

			internal int <$s_1244>__1;

			internal UnityEngine.Object <importer>__2;
			...
			IEnumerator<AudioImporter> IEnumerable<AudioImporter>.GetEnumerator()
			{
				...
				<GetAllAudioImporterTargets>c__Iterator.<>f__this = this.<>f__this;
				return <GetAllAudioImporterTargets>c__Iterator;
			}
			...
			public bool MoveNext()
			{
				...
				{
				case 0u:
					this.<$s_1243>__0 = this.<>f__this.targets;
					this.<$s_1244>__1 = 0;
					break;
				case 1u:
					IL_8B:
				...
				if (this.<$s_1244>__1 >= this.<$s_1243>__0.Length)
				{
					this.$PC = -1;
				}
				else
				{
					this.<importer>__2 = this.<$s_1243>__0[this.<$s_1244>__1];
