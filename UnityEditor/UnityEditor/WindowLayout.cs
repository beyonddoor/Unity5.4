...
namespace UnityEditor
{
	internal class WindowLayout
	{
		...
		{
			internal UnityEngine.Object[] <$s_1159>__0;

			internal int <$s_1160>__1;

			internal UnityEngine.Object <obj>__2;
			...
			public bool MoveNext()
			{
				...
				{
				case 0u:
					this.<$s_1159>__0 = Resources.FindObjectsOfTypeAll(typeof(T));
					this.<$s_1160>__1 = 0;
					break;
				case 1u:
					IL_8C:
				...
				if (this.<$s_1160>__1 >= this.<$s_1159>__0.Length)
				{
					this.$PC = -1;
				}
				else
				{
					this.<obj>__2 = this.<$s_1159>__0[this.<$s_1160>__1];
