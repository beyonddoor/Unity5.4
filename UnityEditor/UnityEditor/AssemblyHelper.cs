...
namespace UnityEditor
{
	internal class AssemblyHelper
	{
		...
		private sealed class <FindImplementors>c__Iterator2<T> : IDisposable, IEnumerator, IEnumerable, IEnumerable<T>, IEnumerator<T> where T : class
		{
			...
			internal Type[] <$s_250>__1;

			internal int <$s_251>__2;
			...
			IEnumerator<T> IEnumerable<T>.GetEnumerator()
			{
				...
				<FindImplementors>c__Iterator.assembly = this.<$>assembly;
				return <FindImplementors>c__Iterator;
			}
			...
			public bool MoveNext()
			{
				...
				case 0u:
					...
					this.<$s_250>__1 = AssemblyHelper.GetTypesFromAssembly(this.assembly);
					this.<$s_251>__2 = 0;
					break;
				case 1u:
					IL_12A:
				...
				if (this.<$s_251>__2 >= this.<$s_250>__1.Length)
				{
					this.$PC = -1;
				}
				else
				{
					this.<type>__3 = this.<$s_250>__1[this.<$s_251>__2];
					if (this.<type>__3.IsInterface || this.<type>__3.IsAbstract || !this.<interfaze>__0.IsAssignableFrom(this.<type>__3))
					{
						goto IL_12A;
					}
					this.<module>__4 = (T)((object)null);
