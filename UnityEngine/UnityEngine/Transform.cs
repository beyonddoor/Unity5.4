namespace UnityEngine
{
    ...
    public class Transform : Component, IEnumerable
    {
        ...
        public int hierarchyCapacity { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] set; }

        public int hierarchyCount { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; }
