namespace UnityEngine
{
    ...
    public sealed class Camera : Behaviour
    {
        ...
        [Obsolete("Camera.DoClear has been deprecated (UnityUpgradable).", true), EditorBrowsable(EditorBrowsableState.Never)]
        public void DoClear()
        {
        }
        ...
        [Obsolete("Property mainCamera has been deprecated. Use Camera.main instead (UnityUpgradable) -> main", true), EditorBrowsable(EditorBrowsableState.Never)]
        ...
        public StereoTargetEyeMask stereoTargetEye { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] set; }
