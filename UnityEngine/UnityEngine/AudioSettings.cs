namespace UnityEngine
{
    ...
    public sealed class AudioSettings
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall), Obsolete("AudioSettings.SetDSPBufferSize is deprecated and has been replaced by audio project settings and the AudioSettings.GetConfiguration/AudioSettings.Reset API."), WrapperlessIcall]
        ...
        internal static bool unityAudioDisabled { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; }
