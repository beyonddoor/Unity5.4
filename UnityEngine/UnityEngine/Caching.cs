namespace UnityEngine
{
    ...
    public sealed class Caching
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall, Obsolete("this API is not for public use.")]
        public static extern bool CleanNamedCache(string name);
        [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall, Obsolete("This function is obsolete and has no effect.")]
        public static extern bool DeleteFromCache(string url);
        [MethodImpl(MethodImplOptions.InternalCall), Obsolete("This function is obsolete and will always return -1. Use IsVersionCached instead."), WrapperlessIcall]
