namespace UnityEngine
{
    ...
    public sealed class Canvas : Behaviour
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall), Obsolete("Shared default material now used for text and general UI elements, call Canvas.GetDefaultCanvasMaterial()"), WrapperlessIcall]
        ...
        public Canvas rootCanvas { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; }
        ...
        public int sortingGridNormalizedSize { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] set; }
