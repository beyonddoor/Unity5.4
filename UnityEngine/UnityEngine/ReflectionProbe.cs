namespace UnityEngine
{
    ...
    public sealed class ReflectionProbe : Behaviour
    {
        ...
        public static int maxBakedCubemapResolution { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; }

        public static int minBakedCubemapResolution { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; }
