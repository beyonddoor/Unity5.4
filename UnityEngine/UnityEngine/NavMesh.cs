namespace UnityEngine
{
    ...
    public sealed class NavMesh
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall), Obsolete("AddOffMeshLinks has no effect and is deprecated."), WrapperlessIcall]
        ...
        [MethodImpl(MethodImplOptions.InternalCall), Obsolete("Use GetAreaCost instead."), WrapperlessIcall]
        public static extern float GetLayerCost(int layer);
        [MethodImpl(MethodImplOptions.InternalCall), Obsolete("Use GetAreaFromName instead."), WrapperlessIcall]
        ...
        [MethodImpl(MethodImplOptions.InternalCall), Obsolete("use NavMesh.CalculateTriangulation() instead."), WrapperlessIcall]
