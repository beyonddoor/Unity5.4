namespace UnityEngine.iOS
{
    ...
    public sealed class LocalNotification
    {
        ...
        public UnityEngine.iOS.CalendarIdentifier repeatCalendar { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] set; }

        public UnityEngine.iOS.CalendarUnit repeatInterval { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] set; }
