namespace UnityEngine
{
    ...
    public class SkinnedMeshRenderer : Renderer
    {
        ...
        public bool skinnedMotionVectors { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] set; }
