namespace UnityEngine
{
    ...
    public sealed class CharacterController : Collider
    {
        ...
        public bool enableOverlapRecovery { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] set; }
