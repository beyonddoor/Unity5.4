namespace UnityEngine
{
    ...
    public class ParticleEmitter : Component
    {
        ...
        public UnityEngine.Particle[] particles { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] set; }
